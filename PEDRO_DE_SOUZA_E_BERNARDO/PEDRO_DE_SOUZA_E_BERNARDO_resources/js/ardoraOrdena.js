...
} else {$("#ardoraQuest").html(vHtml+"<img alt='Play' id='playSound' class='imaLeft' src='PEDRO_DE_SOUZA_E_BERNARDO_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
