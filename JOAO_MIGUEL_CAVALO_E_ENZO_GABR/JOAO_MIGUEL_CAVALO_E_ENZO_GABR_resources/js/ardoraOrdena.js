...
} else {$("#ardoraQuest").html(vHtml+"<img alt='Play' id='playSound' class='imaLeft' src='JOAO_MIGUEL_CAVALO_E_ENZO_GABR_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
